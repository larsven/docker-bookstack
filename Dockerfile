...
RUN set -x; \
	...
	&& chmod a+x "./wkhtmltox_${WKHTMLTOPDF_VERSION}.bullseye_${arch}.deb" \
    && apt-get install -y "./wkhtmltox_${WKHTMLTOPDF_VERSION}.bullseye_${arch}.deb" \
    && rm "./wkhtmltox_${WKHTMLTOPDF_VERSION}.bullseye_${arch}.deb" \
